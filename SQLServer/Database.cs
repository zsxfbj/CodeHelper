...
namespace CodeHelper.SQLServer
{
    ...
    {    
        ...
        public static void AssignParameterValues(SqlParameter[] commandParameters, params object[] parameterValues)
        {
            ...
            {
                throw new ArgumentException("Parameter recordCount does not match Parameter Value recordCount.");
            }
        ...
        public static void AssignParameterValues(SqlParameter commandParameter, object parameterValue)
        {
        ...
        public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, int startRecord, int maxRecords, params SqlParameter[] commandParameters)
        {
            ...
            maxRecords = maxRecords < 1 ? 1 : maxRecords;
            // Create a command and prepare it for execution
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
                                                  ...
                                                  string commandText, params SqlParameter[] commandParameters)
        {
            ...
            return
                ExecuteReader(transaction.Connection, transaction, commandType, commandText, commandParameters,
                              SqlConnectionOwnership.External);
        }
        ...
        /// <returns></returns>
        public static int RunProc(string connectionString, string procName, SqlParameter[] prams)
        {
        ...
        public static void RunProc(string connectionString, string procName, out SqlDataReader reader)
        {
            reader = ExecuteReader(connectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        /// <param name="prams"></param>
        /// <param name="reader"></param>
        public static void RunProc(string connectionString, string procName, SqlParameter[] prams, out SqlDataReader reader)
        {
        ...
        /// <param name="procName"></param>
        /// <param name="ds"></param>
        public static void RunProc(string connectionString, string procName, out DataSet ds)
        {
            ds = ExecuteDataset(connectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        /// <param name="prams"></param>
        /// <param name="ds"></param>
        public static void RunProc(string connectionString, string procName, SqlParameter[] prams, out DataSet ds)
        {
        ...
        public static void RunProc(string connectionString, string procName, out object obj)
        {
            obj = ExecuteScalar(connectionString, CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        /// <param name="prams"></param>
        /// <param name="obj"></param>
        public static void RunProc(string connectionString, string procName, SqlParameter[] prams, out object obj)
        {
        ...
        public static void RunProc(string connectionString, string procName, out XmlReader xmlReader)
        {
            xmlReader = ExecuteXmlReader(new SqlConnection(connectionString), CommandType.StoredProcedure, procName, (SqlParameter[])null);
        }
        ...
        /// <param name="xmlReader"></param>
        /// <returns></returns>
        public static void RunProc(string connectionString, string procName, SqlParameter[] prams, out XmlReader xmlReader)
        {
    ...
    public sealed class ParamsCache
    {
        ...
        /// <returns></returns>
        private static SqlParameter CloneParameters(SqlParameter originalParameter)
        {
            SqlParameter clonedParameter = new SqlParameter();
            clonedParameter = (SqlParameter)((ICloneable)originalParameter).Clone();
